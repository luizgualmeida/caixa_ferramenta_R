# Lista 4: Modelos Hierárquicos e ICC {.unnumbered}

::: {.callout-note appearance="simple" icon=false}
## Objetivo da Lista

Aprenda a trabalhar com **modelos hierárquicos de 3 níveis** (alunos → classes → escolas) e utilize o **ICC** para decidir quais variáveis devem ser efeitos aleatórios.
:::
...
{{< video https://www.youtube.com/watch?v=_1lUvEu8M9c title='HGMM - Aula Prática #4 (SPSS)' >}}
