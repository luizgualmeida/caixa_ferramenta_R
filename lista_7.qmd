# Lista 7: Séries Temporais (ARIMA) {.unnumbered}

::: {.callout-note appearance="simple" icon="false"}
## Objetivo da Lista

Domine **modelos ARIMA** para análise de séries temporais: avaliar estacionaridade, identificar padrões sazonais e fazer previsões futuras. Trabalharemos com dados de consumo de cigarros e salários ao longo do tempo.
:::
...
cat("✓ Pacotes de séries temporais carregados!\n")
```
...
## 📥 Parte 1: Estacionaridade (Dados de Cigarros)
...
## 📊 Parte 2: Modelagem ARIMA (Dados de Salários)
...
**Vídeos em Português:** - [ARIMA em R - Tutorial Completo](https://www.youtube.com/watch?v=Txuo9JQjnKE) - [Playlist Séries Temporais](https://www.youtube.com/watch?v=RJzmHkGWCxs&list=PLEuzmtv9IuT_vg5oE0lQyZR-wgbVeGztt)
:::

------------------------------------------------------------------------

## 🎯 Fluxo de Trabalho ARIMA
...
3.  **Transformar** se necessário (diferenciação, Box-Cox)
4.  **Identificar** p, d, q (ACF, PACF, ou auto.arima)
5.  **Ajustar** modelo
6.  **Diagnosticar** resíduos
